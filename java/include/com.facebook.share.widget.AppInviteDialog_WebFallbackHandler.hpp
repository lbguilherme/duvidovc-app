...
namespace share {
namespace widget {
class AppInviteDialog_WebFallbackHandler : public virtual ::java::lang::Object,
...
public:
    ...
    explicit AppInviteDialog_WebFallbackHandler(jobject _obj) : ::java::lang::Object(_obj), ::com::facebook::internal::FacebookDialogBase_ModeHandler(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    AppInviteDialog_WebFallbackHandler(const ::com::facebook::share::widget::AppInviteDialog_WebFallbackHandler& x) : ::java::lang::Object((jobject)0), ::com::facebook::internal::FacebookDialogBase_ModeHandler((jobject)0) {obj = x.obj;}
    AppInviteDialog_WebFallbackHandler(::com::facebook::share::widget::AppInviteDialog_WebFallbackHandler&& x) : ::java::lang::Object((jobject)0), ::com::facebook::internal::FacebookDialogBase_ModeHandler((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
