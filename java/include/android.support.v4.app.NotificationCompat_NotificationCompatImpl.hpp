...
namespace v4 {
namespace app {
class NotificationCompat_NotificationCompatImpl : public virtual ::java::lang::Object {
public:
    ...
    explicit NotificationCompat_NotificationCompatImpl(jobject _obj) : ::java::lang::Object(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    NotificationCompat_NotificationCompatImpl(const ::android::support::v4::app::NotificationCompat_NotificationCompatImpl& x) : ::java::lang::Object((jobject)0) {obj = x.obj;}
    NotificationCompat_NotificationCompatImpl(::android::support::v4::app::NotificationCompat_NotificationCompatImpl&& x) : ::java::lang::Object((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
