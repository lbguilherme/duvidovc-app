...
namespace v4 {
namespace widget {
class DrawerLayout_AccessibilityDelegate : public virtual ::java::lang::Object,
...
public:
    ...
    explicit DrawerLayout_AccessibilityDelegate(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::view::AccessibilityDelegateCompat(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    DrawerLayout_AccessibilityDelegate(const ::android::support::v4::widget::DrawerLayout_AccessibilityDelegate& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::AccessibilityDelegateCompat((jobject)0) {obj = x.obj;}
    DrawerLayout_AccessibilityDelegate(::android::support::v4::widget::DrawerLayout_AccessibilityDelegate&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::AccessibilityDelegateCompat((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
