...
namespace locks {
class ReentrantReadWriteLock_ReadLock : public virtual ::java::lang::Object,
...
public:
    ...
    explicit ReentrantReadWriteLock_ReadLock(jobject _obj) : ::java::lang::Object(_obj), ::java::io::Serializable(_obj), ::java::util::concurrent::locks::Lock(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    ReentrantReadWriteLock_ReadLock(const ::java::util::concurrent::locks::ReentrantReadWriteLock_ReadLock& x) : ::java::lang::Object((jobject)0), ::java::io::Serializable((jobject)0), ::java::util::concurrent::locks::Lock((jobject)0) {obj = x.obj;}
    ReentrantReadWriteLock_ReadLock(::java::util::concurrent::locks::ReentrantReadWriteLock_ReadLock&& x) : ::java::lang::Object((jobject)0), ::java::io::Serializable((jobject)0), ::java::util::concurrent::locks::Lock((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
