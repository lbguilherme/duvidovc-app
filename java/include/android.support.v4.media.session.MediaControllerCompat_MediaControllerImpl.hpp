...
namespace media {
namespace session {
class MediaControllerCompat_MediaControllerImpl : public virtual ::java::lang::Object {
public:
    ...
    explicit MediaControllerCompat_MediaControllerImpl(jobject _obj) : ::java::lang::Object(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    MediaControllerCompat_MediaControllerImpl(const ::android::support::v4::media::session::MediaControllerCompat_MediaControllerImpl& x) : ::java::lang::Object((jobject)0) {obj = x.obj;}
    MediaControllerCompat_MediaControllerImpl(::android::support::v4::media::session::MediaControllerCompat_MediaControllerImpl&& x) : ::java::lang::Object((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
