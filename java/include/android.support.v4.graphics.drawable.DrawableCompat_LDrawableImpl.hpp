...
namespace graphics {
namespace drawable {
class DrawableCompat_LDrawableImpl : public virtual ::java::lang::Object,
...
public:
    ...
    explicit DrawableCompat_LDrawableImpl(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::graphics::drawable::DrawableCompat_BaseDrawableImpl(_obj), ::android::support::v4::graphics::drawable::DrawableCompat_DrawableImpl(_obj), ::android::support::v4::graphics::drawable::DrawableCompat_HoneycombDrawableImpl(_obj), ::android::support::v4::graphics::drawable::DrawableCompat_KitKatDrawableImpl(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    DrawableCompat_LDrawableImpl(const ::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl& x) : ::java::lang::Object((jobject)0), ::android::support::v4::graphics::drawable::DrawableCompat_BaseDrawableImpl((jobject)0), ::android::support::v4::graphics::drawable::DrawableCompat_DrawableImpl((jobject)0), ::android::support::v4::graphics::drawable::DrawableCompat_HoneycombDrawableImpl((jobject)0), ::android::support::v4::graphics::drawable::DrawableCompat_KitKatDrawableImpl((jobject)0) {obj = x.obj;}
    DrawableCompat_LDrawableImpl(::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::graphics::drawable::DrawableCompat_BaseDrawableImpl((jobject)0), ::android::support::v4::graphics::drawable::DrawableCompat_DrawableImpl((jobject)0), ::android::support::v4::graphics::drawable::DrawableCompat_HoneycombDrawableImpl((jobject)0), ::android::support::v4::graphics::drawable::DrawableCompat_KitKatDrawableImpl((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl& operator=(const ::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl& x) {obj = x.obj; return *this;}
    ::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl& operator=(::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl&& x) {obj = std::move(x.obj); return *this;}
