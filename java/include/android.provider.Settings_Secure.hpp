...
namespace android {
namespace provider {
class Settings_Secure : public virtual ::java::lang::Object,
...
public:
    ...
    explicit Settings_Secure(jobject _obj) : ::java::lang::Object(_obj), ::android::provider::BaseColumns(_obj), ::android::provider::Settings_NameValueTable(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    Settings_Secure(const ::android::provider::Settings_Secure& x) : ::java::lang::Object((jobject)0), ::android::provider::BaseColumns((jobject)0), ::android::provider::Settings_NameValueTable((jobject)0) {obj = x.obj;}
    Settings_Secure(::android::provider::Settings_Secure&& x) : ::java::lang::Object((jobject)0), ::android::provider::BaseColumns((jobject)0), ::android::provider::Settings_NameValueTable((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::provider::Settings_Secure& operator=(const ::android::provider::Settings_Secure& x) {obj = x.obj; return *this;}
    ::android::provider::Settings_Secure& operator=(::android::provider::Settings_Secure&& x) {obj = std::move(x.obj); return *this;}
    ...
    static bool isLocationProviderEnabled(const ::android::content::ContentResolver&, const ::java::lang::String&);
    static void setLocationProviderEnabled(const ::android::content::ContentResolver&, const ::java::lang::String&, bool);
