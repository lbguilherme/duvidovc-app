...
namespace share {
namespace internal {
class LikeDialog_NativeHandler : public virtual ::java::lang::Object,
...
public:
    ...
    explicit LikeDialog_NativeHandler(jobject _obj) : ::java::lang::Object(_obj), ::com::facebook::internal::FacebookDialogBase_ModeHandler(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    LikeDialog_NativeHandler(const ::com::facebook::share::internal::LikeDialog_NativeHandler& x) : ::java::lang::Object((jobject)0), ::com::facebook::internal::FacebookDialogBase_ModeHandler((jobject)0) {obj = x.obj;}
    LikeDialog_NativeHandler(::com::facebook::share::internal::LikeDialog_NativeHandler&& x) : ::java::lang::Object((jobject)0), ::com::facebook::internal::FacebookDialogBase_ModeHandler((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
