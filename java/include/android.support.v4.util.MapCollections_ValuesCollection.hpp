...
namespace v4 {
namespace util {
class MapCollections_ValuesCollection : public virtual ::java::lang::Object,
...
public:
    ...
    explicit MapCollections_ValuesCollection(jobject _obj) : ::java::lang::Object(_obj), ::java::lang::Iterable(_obj), ::java::util::Collection(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    MapCollections_ValuesCollection(const ::android::support::v4::util::MapCollections_ValuesCollection& x) : ::java::lang::Object((jobject)0), ::java::lang::Iterable((jobject)0), ::java::util::Collection((jobject)0) {obj = x.obj;}
    MapCollections_ValuesCollection(::android::support::v4::util::MapCollections_ValuesCollection&& x) : ::java::lang::Object((jobject)0), ::java::lang::Iterable((jobject)0), ::java::util::Collection((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
