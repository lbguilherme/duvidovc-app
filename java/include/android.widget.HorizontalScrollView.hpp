...
namespace android {
namespace widget {
class HorizontalScrollView : public virtual ::java::lang::Object,
...
public:
    ...
    ::android::widget::HorizontalScrollView& operator=(const ::android::widget::HorizontalScrollView& x) {obj = x.obj; return *this;}
    ::android::widget::HorizontalScrollView& operator=(::android::widget::HorizontalScrollView&& x) {obj = std::move(x.obj); return *this;}
    
    HorizontalScrollView(const ::android::content::Context&);
    HorizontalScrollView(const ::android::content::Context&, const ::android::util::AttributeSet&);
    HorizontalScrollView(const ::android::content::Context&, const ::android::util::AttributeSet&, int32_t);
