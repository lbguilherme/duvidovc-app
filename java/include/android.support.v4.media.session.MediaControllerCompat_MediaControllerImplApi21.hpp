...
namespace media {
namespace session {
class MediaControllerCompat_MediaControllerImplApi21 : public virtual ::java::lang::Object,
...
public:
    ...
    explicit MediaControllerCompat_MediaControllerImplApi21(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::media::session::MediaControllerCompat_MediaControllerImpl(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    MediaControllerCompat_MediaControllerImplApi21(const ::android::support::v4::media::session::MediaControllerCompat_MediaControllerImplApi21& x) : ::java::lang::Object((jobject)0), ::android::support::v4::media::session::MediaControllerCompat_MediaControllerImpl((jobject)0) {obj = x.obj;}
    MediaControllerCompat_MediaControllerImplApi21(::android::support::v4::media::session::MediaControllerCompat_MediaControllerImplApi21&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::media::session::MediaControllerCompat_MediaControllerImpl((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::support::v4::media::session::MediaControllerCompat_MediaControllerImplApi21& operator=(const ::android::support::v4::media::session::MediaControllerCompat_MediaControllerImplApi21& x) {obj = x.obj; return *this;}
    ::android::support::v4::media::session::MediaControllerCompat_MediaControllerImplApi21& operator=(::android::support::v4::media::session::MediaControllerCompat_MediaControllerImplApi21&& x) {obj = std::move(x.obj); return *this;}
    
    MediaControllerCompat_MediaControllerImplApi21(const ::android::content::Context&, const ::android::support::v4::media::session::MediaSessionCompat&);
    MediaControllerCompat_MediaControllerImplApi21(const ::android::content::Context&, const ::android::support::v4::media::session::MediaSessionCompat_Token&);
