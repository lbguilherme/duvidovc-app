...
namespace graphics {
namespace drawable {
class ScaleDrawable : public virtual ::java::lang::Object,
...
public:
    ...
    explicit ScaleDrawable(jobject _obj) : ::java::lang::Object(_obj), ::android::graphics::drawable::Drawable(_obj), ::android::graphics::drawable::Drawable_Callback(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    ScaleDrawable(const ::android::graphics::drawable::ScaleDrawable& x) : ::java::lang::Object((jobject)0), ::android::graphics::drawable::Drawable((jobject)0), ::android::graphics::drawable::Drawable_Callback((jobject)0) {obj = x.obj;}
    ScaleDrawable(::android::graphics::drawable::ScaleDrawable&& x) : ::java::lang::Object((jobject)0), ::android::graphics::drawable::Drawable((jobject)0), ::android::graphics::drawable::Drawable_Callback((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::graphics::drawable::ScaleDrawable& operator=(const ::android::graphics::drawable::ScaleDrawable& x) {obj = x.obj; return *this;}
