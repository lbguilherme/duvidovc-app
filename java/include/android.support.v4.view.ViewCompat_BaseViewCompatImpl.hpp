...
namespace v4 {
namespace view {
class ViewCompat_BaseViewCompatImpl : public virtual ::java::lang::Object,
                                      public virtual ::android::support::v4::view::ViewCompat_ViewCompatImpl {
public:
    ...
    explicit ViewCompat_BaseViewCompatImpl(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::view::ViewCompat_ViewCompatImpl(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    ViewCompat_BaseViewCompatImpl(const ::android::support::v4::view::ViewCompat_BaseViewCompatImpl& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::ViewCompat_ViewCompatImpl((jobject)0) {obj = x.obj;}
    ViewCompat_BaseViewCompatImpl(::android::support::v4::view::ViewCompat_BaseViewCompatImpl&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::ViewCompat_ViewCompatImpl((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::support::v4::view::ViewCompat_BaseViewCompatImpl& operator=(const ::android::support::v4::view::ViewCompat_BaseViewCompatImpl& x) {obj = x.obj; return *this;}
    ::android::support::v4::view::ViewCompat_BaseViewCompatImpl& operator=(::android::support::v4::view::ViewCompat_BaseViewCompatImpl&& x) {obj = std::move(x.obj); return *this;}
