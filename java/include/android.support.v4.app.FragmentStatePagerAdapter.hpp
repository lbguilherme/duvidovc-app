...
namespace v4 {
namespace app {
class FragmentStatePagerAdapter : public virtual ::java::lang::Object,
...
public:
    ...
    explicit FragmentStatePagerAdapter(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::view::PagerAdapter(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    FragmentStatePagerAdapter(const ::android::support::v4::app::FragmentStatePagerAdapter& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::PagerAdapter((jobject)0) {obj = x.obj;}
    FragmentStatePagerAdapter(::android::support::v4::app::FragmentStatePagerAdapter&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::PagerAdapter((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::support::v4::app::FragmentStatePagerAdapter& operator=(const ::android::support::v4::app::FragmentStatePagerAdapter& x) {obj = x.obj; return *this;}
