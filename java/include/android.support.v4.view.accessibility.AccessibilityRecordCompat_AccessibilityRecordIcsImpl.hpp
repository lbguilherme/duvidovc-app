...
class AccessibilityRecordCompat_AccessibilityRecordIcsImpl : public virtual ::java::lang::Object,
                                                             public virtual ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordStubImpl {
public:
    ...
    explicit AccessibilityRecordCompat_AccessibilityRecordIcsImpl(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordImpl(_obj), ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordStubImpl(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    AccessibilityRecordCompat_AccessibilityRecordIcsImpl(const ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordIcsImpl& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordImpl((jobject)0), ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordStubImpl((jobject)0) {obj = x.obj;}
    AccessibilityRecordCompat_AccessibilityRecordIcsImpl(::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordIcsImpl&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordImpl((jobject)0), ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordStubImpl((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordIcsImpl& operator=(const ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordIcsImpl& x) {obj = x.obj; return *this;}
    ::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordIcsImpl& operator=(::android::support::v4::view::accessibility::AccessibilityRecordCompat_AccessibilityRecordIcsImpl&& x) {obj = std::move(x.obj); return *this;}
