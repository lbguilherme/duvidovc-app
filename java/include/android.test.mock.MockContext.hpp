...
namespace test {
namespace mock {
class MockContext : public virtual ::java::lang::Object,
...
public:
    ...
    explicit MockContext(jobject _obj) : ::java::lang::Object(_obj), ::android::content::Context(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    MockContext(const ::android::test::mock::MockContext& x) : ::java::lang::Object((jobject)0), ::android::content::Context((jobject)0) {obj = x.obj;}
    MockContext(::android::test::mock::MockContext&& x) : ::java::lang::Object((jobject)0), ::android::content::Context((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::test::mock::MockContext& operator=(const ::android::test::mock::MockContext& x) {obj = x.obj; return *this;}
    ::android::test::mock::MockContext& operator=(::android::test::mock::MockContext&& x) {obj = std::move(x.obj); return *this;}
