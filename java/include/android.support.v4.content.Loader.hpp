...
namespace android { namespace support { namespace v4 { namespace content { class Loader_OnLoadCompleteListener; } } } }
...
public:
    ...
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    Loader(const ::android::support::v4::content::Loader& x) : ::java::lang::Object((jobject)0) {obj = x.obj;}
    Loader(::android::support::v4::content::Loader&& x) : ::java::lang::Object((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::support::v4::content::Loader& operator=(const ::android::support::v4::content::Loader& x) {obj = x.obj; return *this;}
...
#include "android.support.v4.content.Loader_ForceLoadContentObserver.hpp"
