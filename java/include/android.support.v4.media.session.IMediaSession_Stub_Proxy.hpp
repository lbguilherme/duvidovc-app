...
namespace media {
namespace session {
class IMediaSession_Stub_Proxy : public virtual ::java::lang::Object,
...
public:
    ...
    explicit IMediaSession_Stub_Proxy(jobject _obj) : ::java::lang::Object(_obj), ::android::os::IInterface(_obj), ::android::support::v4::media::session::IMediaSession(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    IMediaSession_Stub_Proxy(const ::android::support::v4::media::session::IMediaSession_Stub_Proxy& x) : ::java::lang::Object((jobject)0), ::android::os::IInterface((jobject)0), ::android::support::v4::media::session::IMediaSession((jobject)0) {obj = x.obj;}
    IMediaSession_Stub_Proxy(::android::support::v4::media::session::IMediaSession_Stub_Proxy&& x) : ::java::lang::Object((jobject)0), ::android::os::IInterface((jobject)0), ::android::support::v4::media::session::IMediaSession((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::support::v4::media::session::IMediaSession_Stub_Proxy& operator=(const ::android::support::v4::media::session::IMediaSession_Stub_Proxy& x) {obj = x.obj; return *this;}
    ::android::support::v4::media::session::IMediaSession_Stub_Proxy& operator=(::android::support::v4::media::session::IMediaSession_Stub_Proxy&& x) {obj = std::move(x.obj); return *this;}
