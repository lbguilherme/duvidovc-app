...
class CursorAdapter : public virtual ::java::lang::Object,
                      public virtual ::android::support::v4::widget::CursorFilter_CursorFilterClient,
...
public:
    ...
    explicit CursorAdapter(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::widget::CursorFilter_CursorFilterClient(_obj), ::android::widget::Adapter(_obj), ::android::widget::BaseAdapter(_obj), ::android::widget::Filterable(_obj), ::android::widget::ListAdapter(_obj), ::android::widget::SpinnerAdapter(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    CursorAdapter(const ::android::support::v4::widget::CursorAdapter& x) : ::java::lang::Object((jobject)0), ::android::support::v4::widget::CursorFilter_CursorFilterClient((jobject)0), ::android::widget::Adapter((jobject)0), ::android::widget::BaseAdapter((jobject)0), ::android::widget::Filterable((jobject)0), ::android::widget::ListAdapter((jobject)0), ::android::widget::SpinnerAdapter((jobject)0) {obj = x.obj;}
    CursorAdapter(::android::support::v4::widget::CursorAdapter&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::widget::CursorFilter_CursorFilterClient((jobject)0), ::android::widget::Adapter((jobject)0), ::android::widget::BaseAdapter((jobject)0), ::android::widget::Filterable((jobject)0), ::android::widget::ListAdapter((jobject)0), ::android::widget::SpinnerAdapter((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::support::v4::widget::CursorAdapter& operator=(const ::android::support::v4::widget::CursorAdapter& x) {obj = x.obj; return *this;}
    ::android::support::v4::widget::CursorAdapter& operator=(::android::support::v4::widget::CursorAdapter&& x) {obj = std::move(x.obj); return *this;}
...
#include "android.support.v4.widget.CursorAdapter_ChangeObserver.hpp"
#include "android.support.v4.widget.CursorAdapter_MyDataSetObserver.hpp"
