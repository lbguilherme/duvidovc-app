...
namespace java {
namespace util {
class AbstractList : public virtual ::java::lang::Object,
...
public:
    ...
    explicit AbstractList(jobject _obj) : ::java::lang::Object(_obj), ::java::lang::Iterable(_obj), ::java::util::AbstractCollection(_obj), ::java::util::Collection(_obj), ::java::util::List(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    AbstractList(const ::java::util::AbstractList& x) : ::java::lang::Object((jobject)0), ::java::lang::Iterable((jobject)0), ::java::util::AbstractCollection((jobject)0), ::java::util::Collection((jobject)0), ::java::util::List((jobject)0) {obj = x.obj;}
    AbstractList(::java::util::AbstractList&& x) : ::java::lang::Object((jobject)0), ::java::lang::Iterable((jobject)0), ::java::util::AbstractCollection((jobject)0), ::java::util::Collection((jobject)0), ::java::util::List((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
