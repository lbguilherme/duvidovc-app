...
namespace media {
namespace session {
class MediaControllerCompat : public virtual ::java::lang::Object {
public:
    ...
    explicit MediaControllerCompat(jobject _obj) : ::java::lang::Object(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    MediaControllerCompat(const ::android::support::v4::media::session::MediaControllerCompat& x) : ::java::lang::Object((jobject)0) {obj = x.obj;}
    MediaControllerCompat(::android::support::v4::media::session::MediaControllerCompat&& x) : ::java::lang::Object((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::support::v4::media::session::MediaControllerCompat& operator=(const ::android::support::v4::media::session::MediaControllerCompat& x) {obj = x.obj; return *this;}
    ::android::support::v4::media::session::MediaControllerCompat& operator=(::android::support::v4::media::session::MediaControllerCompat&& x) {obj = std::move(x.obj); return *this;}
    
    MediaControllerCompat(const ::android::content::Context&, const ::android::support::v4::media::session::MediaSessionCompat&);
    MediaControllerCompat(const ::android::content::Context&, const ::android::support::v4::media::session::MediaSessionCompat_Token&);
    ...
    void registerCallback(const ::android::support::v4::media::session::MediaControllerCompat_Callback&) const ;
...
#include "android.support.v4.media.session.MediaControllerCompat_Callback.hpp"
#include "android.support.v4.media.session.MediaControllerCompat_MediaControllerImpl.hpp"
#include "android.support.v4.media.session.MediaControllerCompat_MediaControllerImplApi21.hpp"
#include "android.support.v4.media.session.MediaControllerCompat_MediaControllerImplBase.hpp"
#include "android.support.v4.media.session.MediaControllerCompat_PlaybackInfo.hpp"
#include "android.support.v4.media.session.MediaControllerCompat_TransportControls.hpp"
#include "android.support.v4.media.session.MediaControllerCompat_TransportControlsApi21.hpp"
#include "android.support.v4.media.session.MediaControllerCompat_TransportControlsBase.hpp"
