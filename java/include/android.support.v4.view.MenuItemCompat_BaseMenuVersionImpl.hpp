...
namespace v4 {
namespace view {
class MenuItemCompat_BaseMenuVersionImpl : public virtual ::java::lang::Object,
...
public:
    ...
    explicit MenuItemCompat_BaseMenuVersionImpl(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::view::MenuItemCompat_MenuVersionImpl(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    MenuItemCompat_BaseMenuVersionImpl(const ::android::support::v4::view::MenuItemCompat_BaseMenuVersionImpl& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::MenuItemCompat_MenuVersionImpl((jobject)0) {obj = x.obj;}
    MenuItemCompat_BaseMenuVersionImpl(::android::support::v4::view::MenuItemCompat_BaseMenuVersionImpl&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::MenuItemCompat_MenuVersionImpl((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
