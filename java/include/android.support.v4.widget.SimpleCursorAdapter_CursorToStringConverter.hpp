...
public:
    ...
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    SimpleCursorAdapter_CursorToStringConverter(const ::android::support::v4::widget::SimpleCursorAdapter_CursorToStringConverter& x) : ::java::lang::Object((jobject)0) {obj = x.obj;}
    SimpleCursorAdapter_CursorToStringConverter(::android::support::v4::widget::SimpleCursorAdapter_CursorToStringConverter&& x) : ::java::lang::Object((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
