...
namespace media {
namespace session {
class MediaSessionCompat_MediaSessionImpl : public virtual ::java::lang::Object {
public:
    ...
    explicit MediaSessionCompat_MediaSessionImpl(jobject _obj) : ::java::lang::Object(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    MediaSessionCompat_MediaSessionImpl(const ::android::support::v4::media::session::MediaSessionCompat_MediaSessionImpl& x) : ::java::lang::Object((jobject)0) {obj = x.obj;}
    MediaSessionCompat_MediaSessionImpl(::android::support::v4::media::session::MediaSessionCompat_MediaSessionImpl&& x) : ::java::lang::Object((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
