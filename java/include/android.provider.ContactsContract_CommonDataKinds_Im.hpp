...
namespace android {
namespace provider {
class ContactsContract_CommonDataKinds_Im : public virtual ::java::lang::Object,
...
public:
    ...
    static int32_t getProtocolLabelResource(int32_t);
    static ::java::lang::CharSequence getProtocolLabel(const ::android::content::res::Resources&, int32_t, const ::java::lang::CharSequence&);
