...
namespace android {
namespace content {
class ContextWrapper : public virtual ::java::lang::Object,
                       public virtual ::android::content::Context {
public:
    ...
    explicit ContextWrapper(jobject _obj) : ::java::lang::Object(_obj), ::android::content::Context(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    ContextWrapper(const ::android::content::ContextWrapper& x) : ::java::lang::Object((jobject)0), ::android::content::Context((jobject)0) {obj = x.obj;}
    ContextWrapper(::android::content::ContextWrapper&& x) : ::java::lang::Object((jobject)0), ::android::content::Context((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::content::ContextWrapper& operator=(const ::android::content::ContextWrapper& x) {obj = x.obj; return *this;}
    ::android::content::ContextWrapper& operator=(::android::content::ContextWrapper&& x) {obj = std::move(x.obj); return *this;}
    
    ContextWrapper(const ::android::content::Context&);
