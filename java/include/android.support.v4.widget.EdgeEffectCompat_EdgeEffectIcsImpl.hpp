...
namespace v4 {
namespace widget {
class EdgeEffectCompat_EdgeEffectIcsImpl : public virtual ::java::lang::Object,
...
public:
    ...
    explicit EdgeEffectCompat_EdgeEffectIcsImpl(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::widget::EdgeEffectCompat_EdgeEffectImpl(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    EdgeEffectCompat_EdgeEffectIcsImpl(const ::android::support::v4::widget::EdgeEffectCompat_EdgeEffectIcsImpl& x) : ::java::lang::Object((jobject)0), ::android::support::v4::widget::EdgeEffectCompat_EdgeEffectImpl((jobject)0) {obj = x.obj;}
    EdgeEffectCompat_EdgeEffectIcsImpl(::android::support::v4::widget::EdgeEffectCompat_EdgeEffectIcsImpl&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::widget::EdgeEffectCompat_EdgeEffectImpl((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
