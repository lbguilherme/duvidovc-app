...
namespace test {
namespace mock {
class MockPackageManager : public virtual ::java::lang::Object,
                           public virtual ::android::content::pm::PackageManager {
public:
    ...
    explicit MockPackageManager(jobject _obj) : ::java::lang::Object(_obj), ::android::content::pm::PackageManager(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    MockPackageManager(const ::android::test::mock::MockPackageManager& x) : ::java::lang::Object((jobject)0), ::android::content::pm::PackageManager((jobject)0) {obj = x.obj;}
    MockPackageManager(::android::test::mock::MockPackageManager&& x) : ::java::lang::Object((jobject)0), ::android::content::pm::PackageManager((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
    
    ::android::test::mock::MockPackageManager& operator=(const ::android::test::mock::MockPackageManager& x) {obj = x.obj; return *this;}
    ::android::test::mock::MockPackageManager& operator=(::android::test::mock::MockPackageManager&& x) {obj = std::move(x.obj); return *this;}
