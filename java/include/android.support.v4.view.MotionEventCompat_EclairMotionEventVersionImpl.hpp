...
public:
    ...
    explicit MotionEventCompat_EclairMotionEventVersionImpl(jobject _obj) : ::java::lang::Object(_obj), ::android::support::v4::view::MotionEventCompat_MotionEventVersionImpl(_obj) {}
    #pragma GCC diagnostic pop
    
    #pragma GCC diagnostic push
    #pragma GCC diagnostic ignored "-Wreorder"
    MotionEventCompat_EclairMotionEventVersionImpl(const ::android::support::v4::view::MotionEventCompat_EclairMotionEventVersionImpl& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::MotionEventCompat_MotionEventVersionImpl((jobject)0) {obj = x.obj;}
    MotionEventCompat_EclairMotionEventVersionImpl(::android::support::v4::view::MotionEventCompat_EclairMotionEventVersionImpl&& x) : ::java::lang::Object((jobject)0), ::android::support::v4::view::MotionEventCompat_MotionEventVersionImpl((jobject)0) {obj = x.obj; x.obj = JavaObjectHolder((jobject)0);}
    #pragma GCC diagnostic pop
