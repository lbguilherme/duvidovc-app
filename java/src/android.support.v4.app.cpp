...
::android::view::View android::support::v4::app::FragmentManagerImpl::onCreateView(const ::java::lang::String& arg0, const ::android::content::Context& arg1, const ::android::util::AttributeSet& arg2) const {
    if (!::android::support::v4::app::FragmentManagerImpl::_class) ::android::support::v4::app::FragmentManagerImpl::_class = java::fetch_class("android/support/v4/app/FragmentManagerImpl");
