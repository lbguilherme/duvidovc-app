...
jclass android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class = nullptr;
...
void android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::setHotspot(const ::android::graphics::drawable::Drawable& arg0, float arg1, float arg2) const {
    if (!::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class) ::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class = java::fetch_class("android/support/v4/graphics/drawable/DrawableCompat$LDrawableImpl");
    static jmethodID mid = java::jni->GetMethodID(_class, "setHotspot", "(Landroid/graphics/drawable/Drawable;FF)V");
    jobject _arg0 = arg0.obj;
    float _arg1 = arg1;
    float _arg2 = arg2;
...
void android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::setHotspotBounds(const ::android::graphics::drawable::Drawable& arg0, int32_t arg1, int32_t arg2, int32_t arg3, int32_t arg4) const {
    if (!::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class) ::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class = java::fetch_class("android/support/v4/graphics/drawable/DrawableCompat$LDrawableImpl");
    static jmethodID mid = java::jni->GetMethodID(_class, "setHotspotBounds", "(Landroid/graphics/drawable/Drawable;IIII)V");
    jobject _arg0 = arg0.obj;
    int32_t _arg1 = arg1;
...
void android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::setTint(const ::android::graphics::drawable::Drawable& arg0, int32_t arg1) const {
    if (!::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class) ::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class = java::fetch_class("android/support/v4/graphics/drawable/DrawableCompat$LDrawableImpl");
    static jmethodID mid = java::jni->GetMethodID(_class, "setTint", "(Landroid/graphics/drawable/Drawable;I)V");
    jobject _arg0 = arg0.obj;
    int32_t _arg1 = arg1;
...
void android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::setTintList(const ::android::graphics::drawable::Drawable& arg0, const ::android::content::res::ColorStateList& arg1) const {
    if (!::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class) ::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class = java::fetch_class("android/support/v4/graphics/drawable/DrawableCompat$LDrawableImpl");
    static jmethodID mid = java::jni->GetMethodID(_class, "setTintList", "(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V");
    jobject _arg0 = arg0.obj;
    jobject _arg1 = arg1.obj;
...
void android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::setTintMode(const ::android::graphics::drawable::Drawable& arg0, const ::android::graphics::PorterDuff_Mode& arg1) const {
    if (!::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class) ::android::support::v4::graphics::drawable::DrawableCompat_LDrawableImpl::_class = java::fetch_class("android/support/v4/graphics/drawable/DrawableCompat$LDrawableImpl");
    static jmethodID mid = java::jni->GetMethodID(_class, "setTintMode", "(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V");
    jobject _arg0 = arg0.obj;
    jobject _arg1 = arg1.obj;
